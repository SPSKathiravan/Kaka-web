...
const MENU = {
  "Appetizers": [
    { name: "Muqabbilat", nameAr: "مقبلات", desc: "Mixed appetizer platter", descAr: "طبق مقبلات مشكل", price: "SAR 15.00" },
    { name: "Olive Mix Salad", nameAr: "سلطة زيتون مشكل", desc: "Fresh mixed olives with herbs", descAr: "زيتون مشكل طازج مع الأعشاب", price: "SAR 10.00" },
    { name: "Hummus", nameAr: "حمص", desc: "Creamy chickpea dip with olive oil", descAr: "حمص كريمي مع زيت الزيتون", price: "SAR 7.00", tag: "Popular" },
    { name: "Mutabbal", nameAr: "متبل", desc: "Roasted eggplant dip", descAr: "متبل باذنجان مشوي", price: "SAR 7.00" },
    { name: "Tabbouleh", nameAr: "تبولة", desc: "Parsley, mint, and bulgur salad", descAr: "سلطة البقدونس والنعناع والبرغل", price: "SAR 7.00" },
    { name: "Green Salad", nameAr: "سلطة خضراء", desc: "Fresh garden green salad", descAr: "سلطة خضراء طازجة", price: "SAR 7.00" },
    { name: "Baba Ghanoush", nameAr: "بابا غنوج", desc: "Smoky eggplant with veggies", descAr: "باذنجان مدخن مع الخضار", price: "SAR 7.00" },
    { name: "Qiyar Bil Laban", nameAr: "خيار باللبن", desc: "Cucumber with yoghurt dip", descAr: "خيار مع اللبن", price: "SAR 7.00" },
    { name: "Olive Salad", nameAr: "سلطة زيتون", desc: "Classic olive salad", descAr: "سلطة زيتون كلاسيكية", price: "SAR 7.00" },
    { name: "Garlic Sauce", nameAr: "صلصة ثوم", desc: "Creamy garlic sauce — available in small (SAR 3) or large (SAR 5)", descAr: "صلصة ثوم كريمية — صغير (٣ ريال) أو كبير (٥ ريال)", price: "SAR 3 / 5" },
  ],
  "Shawarma": [
    { name: "Shawarma Plate", nameAr: "طبق شاورما", desc: "Full plate with fries and garlic sauce — Small / Medium / Large", descAr: "طبق كامل مع البطاطس وصلصة الثوم — صغير / وسط / كبير", price: "SAR 22 / 32 / 52", tag: "Bestseller" },
    { name: "Shawarma Slices", nameAr: "شرائح شاورما", desc: "Sliced chicken shawarma portion", descAr: "وجبة شرائح شاورما دجاج", price: "SAR 15.00" },
    { name: "Shawarma Roll - Large", nameAr: "شاورما كبير", desc: "Large chicken shawarma roll", descAr: "ساندوتش شاورما دجاج كبير", price: "SAR 12.00" },
    { name: "Shawarma Roll - Small", nameAr: "شاورما صغير", desc: "Classic chicken shawarma roll", descAr: "ساندوتش شاورما دجاج كلاسيكي", price: "SAR 8.00" },
  ],
  "Chicken": [
    { name: "Al Faham (Half)", nameAr: "نصف فحم", desc: "Charcoal grilled Arabian chicken", descAr: "دجاج عربي مشوي على الفحم", price: "SAR 20.00" },
    { name: "Al Faham (Full)", nameAr: "فحم كامل", desc: "Whole charcoal grilled Arabian chicken", descAr: "دجاج عربي كامل مشوي على الفحم", price: "SAR 38.00", tag: "Popular" },
    { name: "Chicken - Hari Hari", nameAr: "دجاج هاري هاري", desc: "Spicy green marinated chicken", descAr: "دجاج متبل حار باللون الأخضر", price: "SAR 8.00" },
    { name: "Chicken Madhgout (Half)", nameAr: "نصف مضغوط دجاج", desc: "Pressure-cooked spiced chicken rice", descAr: "أرز ودجاج مبهر مطبوخ بالضغط", price: "SAR 30.00" },
  ],
  "Chops": [
    { name: "Mutton Chops (Plate - 4 Pcs)", nameAr: "ريش غنم (طبق - 4 قطع)", desc: "Premium marinated mutton chops", descAr: "ريش غنم متبلة فاخرة", price: "SAR 50.00", tag: "Premium" },
    { name: "Beef Chops (Plate - 2 Pcs)", nameAr: "ريش لحم بقري (طبق - 2 قطع)", desc: "Juicy marinated beef chops", descAr: "ريش لحم بقري متبلة طرية", price: "SAR 40.00", tag: "Premium" },
  ],
  "Awsal": [
    { name: "Beef Awsal (Per Skewer)", nameAr: "أوصال لحم بقري (للسيخ)", desc: "Tender beef chunks on skewer — minimum 2 skewers", descAr: "قطع لحم بقري طرية مشوية — حد أدنى سيخان", price: "SAR 8.00" },
    { name: "Camel Awsal (Per Skewer)", nameAr: "أوصال لحم إبل (للسيخ)", desc: "Juicy camel chunks on skewer — minimum 2 skewers", descAr: "قطع لحم إبل طرية مشوية — حد أدنى سيخان", price: "SAR 8.00" },
  ],
  "Grilled - Boneless": [
    { name: "Chicken - Red (Per Skewer)", nameAr: "دجاج أحمر (للسيخ)", desc: "Red-marinated boneless chicken skewer — minimum 2 skewers", descAr: "سيخ دجاج بدون عظم تتبيلة حمراء — حد أدنى سيخان", price: "SAR 8.00" },
    { name: "Chicken - Hari Hari (Per Skewer)", nameAr: "دجاج هاري هاري (للسيخ)", desc: "Spicy green marinated boneless chicken — minimum 2 skewers", descAr: "سيخ دجاج بدون عظم تتبيلة خضراء حارة — حد أدنى سيخان", price: "SAR 8.00" },
    { name: "Chicken - Malai (Per Skewer)", nameAr: "دجاج مالاي (للسيخ)", desc: "Creamy malai marinated boneless chicken — minimum 2 skewers", descAr: "سيخ دجاج بدون عظم تتبيلة مالاي كريمية — حد أدنى سيخان", price: "SAR 8.00" },
    { name: "Chicken - Capsicum (Per Skewer)", nameAr: "دجاج كابسيكوم (للسيخ)", desc: "Capsicum marinated boneless chicken — minimum 2 skewers", descAr: "سيخ دجاج بدون عظم تتبيلة فلفل — حد أدنى سيخان", price: "SAR 8.00" },
  ],
  "Grilled - With Bone": [
    { name: "Al Faham (Half / Full)", nameAr: "الفحم (نصف / كامل)", desc: "Charcoal grilled Arabian chicken — Half or Full", descAr: "دجاج عربي مشوي على الفحم — نصف أو كامل", price: "SAR 20 / 40", tag: "Popular" },
    { name: "Shawaya (Half / Full)", nameAr: "شواية (نصف / كامل)", desc: "Traditional flame-grilled chicken — Half or Full", descAr: "دجاج مشوي على اللهب بالطريقة التقليدية — نصف أو كامل", price: "SAR 18 / 36" },
    { name: "Chicken - Red (Per Skewer)", nameAr: "دجاج أحمر بعظم (للسيخ)", desc: "Red-marinated chicken with bone — minimum 2 skewers", descAr: "سيخ دجاج بعظم تتبيلة حمراء — حد أدنى سيخان", price: "SAR 9.00" },
    { name: "Chicken - Hari Hari (Per Skewer)", nameAr: "دجاج هاري هاري بعظم (للسيخ)", desc: "Spicy green marinated chicken with bone — minimum 2 skewers", descAr: "سيخ دجاج بعظم تتبيلة خضراء حارة — حد أدنى سيخان", price: "SAR 9.00" },
    { name: "Chicken - Malai (Per Skewer)", nameAr: "دجاج مالاي بعظم (للسيخ)", desc: "Creamy malai marinated chicken with bone — minimum 2 skewers", descAr: "سيخ دجاج بعظم تتبيلة مالاي — حد أدنى سيخان", price: "SAR 9.00" },
    { name: "Chicken - Capsicum (Per Skewer)", nameAr: "دجاج كابسيكوم بعظم (للسيخ)", desc: "Capsicum marinated chicken with bone — minimum 2 skewers", descAr: "سيخ دجاج بعظم تتبيلة فلفل — حد أدنى سيخان", price: "SAR 9.00" },
    { name: "Chicken - Wings (Per Skewer)", nameAr: "أجنحة دجاج (للسيخ)", desc: "Grilled chicken wings skewer — minimum 2 skewers", descAr: "سيخ أجنحة دجاج مشوية — حد أدنى سيخان", price: "SAR 8.00" },
  ],
  "Kabab": [
    { name: "Lamb Cheese Kabab", nameAr: "كباب لحم الحمل بالجبن", desc: "Minced lamb kabab with cheese filling", descAr: "كباب لحم حمل مفروم محشو بالجبن", price: "SAR 35.00", tag: "Premium" },
    { name: "Chicken Cheese Kabab", nameAr: "كباب دجاج بالجبن", desc: "Minced chicken kabab with cheese filling", descAr: "كباب دجاج مفروم محشو بالجبن", price: "SAR 32.00" },
    { name: "Chicken Kabab (Per Skewer)", nameAr: "كباب دجاج (للسيخ)", desc: "Spiced minced chicken kabab — minimum 2 skewers", descAr: "كباب دجاج مفروم متبل — حد أدنى سيخان", price: "SAR 8.00", tag: "Popular" },
    { name: "Mutton Kabab (Per Skewer)", nameAr: "كباب غنم (للسيخ)", desc: "Juicy minced mutton kabab — minimum 2 skewers", descAr: "كباب غنم مفروم طري — حد أدنى سيخان", price: "SAR 8.00" },
  ],
  "Drinks": [
    { name: "Kinza - Cola / Lemon / Citrus", nameAr: "كينزا - كولا / ليمون / حمضيات", desc: "Refreshing Kinza soda — Cola, Lemon or Citrus flavour", descAr: "مشروب كينزا الغازي — كولا أو ليمون أو حمضيات", price: "SAR 2.00" },
    { name: "Water", nameAr: "ماء", desc: "Chilled mineral water", descAr: "مياه معدنية مثلجة", price: "SAR 1.00" },
  ],
  "Broasted": [
    { name: "Broasted 4 Pcs", nameAr: "بروستد 4 قطع", desc: "Crispy fried chicken 4 pieces with fries", descAr: "دجاج مقلي مقرمش 4 قطع مع البطاطس", price: "SAR 22.00" },
    { name: "Crispy Fried Chicken Tenders", nameAr: "ستربس دجاج مقرمش", desc: "Crispy boneless chicken tenders", descAr: "شرائح دجاج مقرمشة بدون عظم", price: "SAR 20.00", tag: "Popular" },
    { name: "Broasted Slice", nameAr: "شريحة بروستد", desc: "Single crispy broasted chicken slice", descAr: "شريحة دجاج بروستد مقرمشة", price: "SAR 15.00" },
    { name: "French Fries Plate", nameAr: "طبق بطاطس مقلية", desc: "Golden crispy french fries", descAr: "بطاطس مقلية ذهبية مقرمشة", price: "SAR 10.00" },
    { name: "Broasted Roll", nameAr: "رول بروستد", desc: "Crispy broasted chicken roll", descAr: "رول دجاج بروستد مقرمش", price: "SAR 10.00" },
  ],
  "Mixed Grill": [
    { name: "Mixed - 18 Skewer", nameAr: "مشكل 18 سيخ", desc: "6 Skewers Chicken with Bone / 12 Mix Skewers Boneless", descAr: "6 أسياخ دجاج بعظم / 12 سيخ مشكل بدون عظم", price: "SAR 132.00", tag: "For Sharing" },
    { name: "Mixed - 11 Skewer", nameAr: "مشكل 11 سيخ", desc: "4 Skewers Chicken / 2 Beef Awsal / 1 Camel Awsal / 2 Mutton Kabab / 2 Chicken Kabab", descAr: "4 أسياخ دجاج / 2 أوصال لحم بقري / 1 أوصال إبل / 2 كباب غنم / 2 كباب دجاج", price: "SAR 80.00", tag: "For Sharing" },
    { name: "Mixed - Chicken with Bone 8 Skewer", nameAr: "مشكل دجاج بعظم 8 أسياخ", desc: "8 Skewers Chicken with Bone (Red / Hari Hari / Malai / Capsicum)", descAr: "8 أسياخ دجاج بعظم (أحمر / هاري هاري / مالاي / كابسيكوم)", price: "SAR 62.00" },
    { name: "Mixed - Chicken Boneless 8 Skewer", nameAr: "مشكل دجاج بدون عظم 8 أسياخ", desc: "8 Skewers Boneless Chicken (Red / Hari Hari / Malai / Capsicum)", descAr: "8 أسياخ دجاج بدون عظم (أحمر / هاري هاري / مالاي / كابسيكوم)", price: "SAR 58.00" },
  ],
  "Rice": [
    { name: "Beef Madhgout (Full / Half)", nameAr: "مضغوط لحم بقري (كامل / نصف)", desc: "Pressure-cooked spiced beef rice — Full or Half", descAr: "أرز ولحم بقري مبهر مطبوخ بالضغط — كامل أو نصف", price: "SAR 240 / 120", tag: "Premium" },
    { name: "Mutton Waleema", nameAr: "وليمة لحم", desc: "Traditional slow-cooked mutton rice", descAr: "أرز بلحم الغنم مطبوخ ببطء بالطريقة التقليدية", price: "SAR 150.00", tag: "Feast" },
    { name: "Chicken Madhgout (Full / Half)", nameAr: "مضغوط دجاج (كامل / نصف)", desc: "Pressure-cooked spiced chicken rice — Full or Half", descAr: "أرز ودجاج مبهر مطبوخ بالضغط — كامل أو نصف", price: "SAR 60 / 30" },
    { name: "Briyani Rice With Al Faham (Full / Half)", nameAr: "أرز برياني مع الفحم (كامل / نصف)", desc: "Fragrant biryani rice with Al Faham chicken — Full or Half", descAr: "أرز برياني عطري مع دجاج الفحم — كامل أو نصف", price: "SAR 60 / 30", tag: "Popular" },
    { name: "Madhgout Rice With Al Faham (Full / Half)", nameAr: "أرز مضغوط مع الفحم (كامل / نصف)", desc: "Pressure-cooked rice with Al Faham chicken — Full or Half", descAr: "أرز مطبوخ بالضغط مع دجاج الفحم — كامل أو نصف", price: "SAR 60 / 30" },
    { name: "Briyani Rice With Shawaya (Full / Half)", nameAr: "أرز برياني مع الشواية (كامل / نصف)", desc: "Fragrant biryani rice with grilled Shawaya chicken", descAr: "أرز برياني عطري مع دجاج الشواية — كامل أو نصف", price: "SAR 56 / 28" },
    { name: "Madhgout Rice With Shawaya (Full / Half)", nameAr: "أرز مضغوط مع الشواية (كامل / نصف)", desc: "Pressure-cooked rice with grilled Shawaya chicken — Full or Half", descAr: "أرز مطبوخ بالضغط مع دجاج الشواية — كامل أو نصف", price: "SAR 56 / 28" },
  ],
  "Mojitos": [
    { name: "Strawberry Mojito", nameAr: "موهيتو فراولة", desc: "Fresh mint, lime, and strawberry", descAr: "نعناع طازج، ليمون، وفراولة", price: "SAR 12.00", tag: "Popular" },
    { name: "Pomegranate Mojito", nameAr: "موهيتو رمان", desc: "Fresh pomegranate and mint mojito", descAr: "موهيتو رمان طازج مع النعناع", price: "SAR 12.00" },
    { name: "Blue Curacao Mojito", nameAr: "موهيتو بلو كوراساو", desc: "Blue curacao citrus mojito", descAr: "موهيتو بلو كوراساو حمضي", price: "SAR 12.00" },
    { name: "Lime Refreshment Mojito", nameAr: "موهيتو ليمون منعش", desc: "Classic lime and mint refreshment mojito", descAr: "موهيتو ليمون ونعناع كلاسيكي منعش", price: "SAR 12.00" },
    { name: "Mint Mojito", nameAr: "موهيتو نعناع", desc: "Pure fresh mint mojito", descAr: "موهيتو نعناع طازج خالص", price: "SAR 12.00" },
  ],
  "Kulukki": [
    { name: "Refreshing Kulukki", nameAr: "كولوكي منعش", desc: "Shaken iced refreshing mocktail", descAr: "موكطيل مثلج منعش مخفوق", price: "SAR 10.00" },
    { name: "Pineapple Kulukki", nameAr: "كولوكي أناناس", desc: "Shaken iced pineapple mocktail", descAr: "موكطيل أناناس مثلج مخفوق", price: "SAR 10.00" },
    { name: "Green Mango Kulukki", nameAr: "كولوكي مانجو أخضر", desc: "Shaken iced green mango mocktail", descAr: "موكطيل مانجو أخضر مثلج مخفوق", price: "SAR 10.00", tag: "Popular" },
    { name: "Watermelon Kulukki", nameAr: "كولوكي بطيخ", desc: "Shaken iced watermelon mocktail", descAr: "موكطيل بطيخ مثلج مخفوق", price: "SAR 10.00" },
    { name: "Passion Fruit Kulukki", nameAr: "كولوكي باشن فروت", desc: "Shaken iced passion fruit mocktail", descAr: "موكطيل باشن فروت مثلج مخفوق", price: "SAR 10.00" },
  ],
  "Smoothie / Juice": [
    { name: "Kit Kat Shake", nameAr: "كيت كات شيك", desc: "Blended Kit Kat chocolate shake", descAr: "شيك كيت كات شوكولاتة مخفوق", price: "SAR 15.00" },
    { name: "Oreo Shake", nameAr: "ميلك شيك أوريو", desc: "Blended cookies and cream shake", descAr: "شيك بسكويت وكريمة مخفوق", price: "SAR 15.00", tag: "Popular" },
    { name: "Ell Juice", nameAr: "عصير إل", desc: "Special Ell juice blend", descAr: "مزيج عصير إل المميز", price: "SAR 15.00" },
    { name: "Fresh Orange Juice", nameAr: "عصير برتقال طازج", desc: "Freshly squeezed oranges", descAr: "عصير برتقال طازج معصور", price: "SAR 12.00" },
    { name: "Fresh Avocado Juice", nameAr: "عصير أفوكادو طازج", desc: "Creamy fresh avocado juice", descAr: "عصير أفوكادو طازج كريمي", price: "SAR 12.00" },
    { name: "Fresh Mango Juice", nameAr: "عصير مانجو طازج", desc: "Freshly blended mango juice", descAr: "عصير مانجو طازج مخلوط", price: "SAR 12.00" },
    { name: "Fresh Pomegranate Juice", nameAr: "عصير رمان طازج", desc: "Freshly squeezed pomegranate juice", descAr: "عصير رمان طازج معصور", price: "SAR 12.00" },
  ],
};

const GALLERY = [
  { url: "images/gallery/gallery-1.jpg", captionEn: "Mixed Grill Sizzler", captionAr: "سيزلر مشاوي مشكلة" },
  { url: "images/gallery/gallery-2.jpg", captionEn: "Kebab Night", captionAr: "ليلة الكباب" },
  { url: "images/gallery/gallery-3.jpg", captionEn: "Our Ambiance", captionAr: "أجواء المطعم" },
  { url: "images/gallery/gallery-4.jpg", captionEn: "Fine Dining", captionAr: "عشاء فاخر" },
  { url: "images/gallery/gallery-5.jpg", captionEn: "Fresh Ingredients", captionAr: "مكونات طازجة" },
  { url: "images/gallery/gallery-6.jpg", captionEn: "Chef's Special", captionAr: "طبق الشيف المميز" },
];
...
const CATEGORY_ICONS = {
  ...
  "Kulukki": "fa-ice-cream",
  "Smoothie / Juice": "fa-blender",
};
...
.mobile-nav-link {
  color: rgba(255,255,255,0.8); text-decoration: none; font-weight: 500; font-size: 0.95rem;
  cursor: pointer; padding: 14px 20px; border-radius: 12px;
...
.shimmer-line {
  position: absolute; bottom: 0; width: 1px; background: linear-gradient(to top, rgba(201,169,110,0.2), transparent);
  animation: shimmerRise linear infinite;
  filter: blur(0.5px);
}
@keyframes shimmerRise {
  ...
  20%  { opacity: 1; }
  80%  { opacity: 0.3; }
  100% { height: 40%; opacity: 0; transform: translateX(var(--sx, 10px)); }
}
...
/* ── FOOTER ── */
footer { background: linear-gradient(180deg, #060606 0%, #000 100%); border-top: 1px solid var(--border); padding: 5rem 5vw 2rem; position: relative; z-index: 1; overflow: hidden; }
footer::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 1px; background: linear-gradient(90deg, transparent, rgba(201,169,110,0.1), var(--gold), rgba(201,169,110,0.1), transparent); }
...
.footer-contact-item { display: flex; align-items: center; gap: 14px; margin-bottom: 1.2rem; color: var(--text-muted); font-size: 0.9rem; transition: var(--transition); }
...
@media (max-width: 640px) {
  ...
  .menu-card:active { transform: scale(0.985); border-color: rgba(192,57,43,0.3); }
  ...
  .footer-contact-item { gap: 12px; margin-bottom: 1rem; }
...
function HeroShimmer() {
  const lines = Array.from({ length: 8 }, (_, i) => ({
    id: i, left: 10 + i * 12 + (Math.random() * 4), duration: 3 + Math.random() * 4, delay: Math.random() * 5, sx: (Math.random() - 0.5) * 30,
  }));
  return (
    <div className="hero-shimmer">
      {lines.map(l => (
        <div key={l.id} className="shimmer-line" style={{ left: `${l.left}%`, animationDuration: `${l.duration}s`, animationDelay: `${l.delay}s`, ...({"--sx": `${l.sx}px`} as any) }} />
      ))}
    </div>
  );
}

function Navbar({ currentView, setCurrentView, lang, setLang }: { currentView: string; setCurrentView: (v: string) => void; lang: string; setLang: (l: string) => void }) {
  ...
  useEffect(() => {
    const handler = (e: Event) => {
      if (menuOpen && !(e.target as HTMLElement).closest('nav')) setMenuOpen(false);
    };
  ...
  return (
    <div className={`nav-wrapper ${scrolled || currentView !== "home" ? "scrolled" : ""}`}>
      <nav>
        <img src={HERO_LOGO_URL} alt="Kaka Grill" className="nav-logo" onClick={() => handleNav("home", undefined)} />
        <div className="nav-links-container">
          <ul className="nav-links">
            <li><a className={`nav-link ${currentView === "home" && activeSection === "home" ? "active" : ""}`} onClick={() => handleNav("home", undefined)}>{text.home}</a></li>
            <li><a className={`nav-link ${currentView === "menu" ? "active" : ""}`} onClick={() => handleNav("menu", undefined)}>{text.menu}</a></li>
        ...
        <div className={`mobile-nav-dropdown ${menuOpen ? 'open' : ''}`}>
          <a className={`mobile-nav-link ${currentView === "home" && activeSection === "home" ? "active" : ""}`} onClick={() => handleNav("home", undefined)}>{text.home}</a>
          <a className={`mobile-nav-link ${currentView === "menu" ? "active" : ""}`} onClick={() => handleNav("menu", undefined)}>{text.menu}</a>
...
function StatsStrip({ lang }: { lang: string }) {
...
function HomeMenuPreview({ onNavigateToMenu, lang }: { onNavigateToMenu: () => void; lang: string }) {
...
function LogoDivider() {
  return (
    <div className="logo-divider">
      ...
      <img src={HERO_LOGO_URL} alt="" style={{ height: "28px", filter: "grayscale(1) brightness(2.5)", opacity: 0.7, transition: '0.4s' }} onMouseEnter={e => { (e.target as HTMLImageElement).style.opacity = '1'; (e.target as HTMLImageElement).style.filter = 'none'; }} onMouseLeave={e => { (e.target as HTMLImageElement).style.opacity = '0.7'; (e.target as HTMLImageElement).style.filter = 'grayscale(1) brightness(2.5)'; }} />
      <div className="logo-divider-line" style={{ background: 'linear-gradient(90deg, transparent, var(--gold), transparent)' }} />
    </div>
  );
}

function BookTablePage({ onNavigateHome, lang }: { onNavigateHome: () => void; lang: string }) {
    ...
    <div className="detail-page" style={{ position: "relative", zIndex: 1 }}>
      <div className="category-detail-hero" style={{ padding: "9rem 5vw 3rem" }}>
        <button className="btn btn-outline" onClick={onNavigateHome}
          style={{ position: "relative", top: "auto", left: "auto", marginBottom: "2rem", padding: "10px 20px", fontSize: "0.8rem", zIndex: 100 }}>
...
function FullMenuPage({ onNavigateHome, onSelectCategory, lang }: { onNavigateHome: () => void; onSelectCategory: (cat: string) => void; lang: string }) {
  ...
  return (
    <div style={{ paddingTop: "100px", minHeight: "100vh", position: "relative", zIndex: 1 }}>
      <div style={{ maxWidth: "1300px", margin: "0 auto", padding: "0 5vw 2rem" }}>
        <button onClick={onNavigateHome} className="btn btn-outline" style={{ padding: "10px 20px", fontSize: "0.8rem" }}>
      ...
      <div className="category-grid">
        {categories.map((cat, index) => {
          const count = ((MENU as any)[cat] || []).length;
          const icon = (CATEGORY_ICONS as any)[cat] || "fa-utensils";
          return (
            <div
              key={cat}
...
function CategoryDetailPage({ category, onBack, lang }: { category: string; onBack: () => void; lang: string }) {
  const text = (T as any)[lang].fullMenu;
  const catText = (T as any)[lang].categories;
  const items = (MENU as any)[category] || [];
  const icon = (CATEGORY_ICONS as any)[category] || "fa-utensils";
      ...
      <div className="gallery-accordion reveal-scale">
        {GALLERY.map((img, i) => {
          ...
          return (
            ...
            >
              <img src={img.url} alt={img.captionEn} className="gallery-accordion-bg" loading="lazy" />
    ...
    <footer>
      ...
      <div className="footer-grid">
        <div className="footer-col" style={{ paddingRight: '1rem' }}>
          ...
          <p>{text.desc}</p>
          <a href="https://www.instagram.com/kaka_grill" target="_blank" rel="noopener noreferrer" className="social-links-pill" title="Follow us on Instagram">
            <div className="social-icon-wrapper"><i className="fab fa-instagram"></i></div>
            <span className="ig-handle">@kaka_grill</span>
          </a>
        </div>
...
setCurrentView={(v: string) => {  setCurrentView(v);
